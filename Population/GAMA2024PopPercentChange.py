...
out_folder = r"C:\Users\sophi\SA-GEOG392-Lab\Labs\Project\Output_Files\GAMA Population Output"
gdb_name   = "GAMAPopulationData.gdb"
gdb        = os.path.join(out_folder, gdb_name)

# CSV with population change data
population_csv = r"C:\Users\sophi\SA-GEOG392-Lab\Labs\Project\Pop Data\csv files\GAMA Percent PopChange.csv"
population_table_name = "PopulationPerChange2024"
...
joined_fc_name = "GAMAPopulationPercentChange2024"
...
arcpy.management.JoinField(
    ...
    fields    = ["Pop2010", "Pop2020", "PopChan", "PercChange"]
)
